...
{
    public class UnaryOperationParser : OperationParserBase<IUnaryOperation>
    {
        public UnaryOperationParser(IOperationHandler handler, ICommandBuilder output) : base(handler, output)
        {
        }

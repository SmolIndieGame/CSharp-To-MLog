    ...
    public class CompilationException : Exception
    {
        public static string GetMessage(CompilationError error)
        {
            return error switch
            {
                ...
                CompilationError.CastingEnum => "Enum that represent types cannot be cast to anything except System.Object.",
                CompilationError.CastToEnum => "Enum that represent types cannot be cast from anything except System.Object.",

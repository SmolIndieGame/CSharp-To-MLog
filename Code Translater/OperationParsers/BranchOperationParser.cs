...
{
    internal class BranchOperationParser : OperationParserBase<IBranchOperation>
    {
        public BranchOperationParser(OperationHandler handler, CommandBuilder output) : base(handler, output)
        {
        }
